...
//go:generate mockgen.sh github.com/awslabs/ecs-secrets/modules/cache Cache mock/cache_mock.go

const (
	// TODO: Recommend memory size in README
	KeyCacheSize = 1000
	KeyCacheTTL  = 1 * time.Hour
)

// Cache defines the interface used by the LRUCache
